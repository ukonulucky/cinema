...
import { HomeOutlined, ListOutlined, MovieCreationOutlined, NotificationsOutlined, VolunteerActivismOutlined } from "@mui/icons-material";
const MenuCollapsed = () => {
  ...
  return (
    <>
       <div className="logo" onClick={
                () => {
                  setmenuCollapse( menuCollapse ? false : true)
               }
              }>
