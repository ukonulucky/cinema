  ...
  return (
      <div className="register">
          ...
          <div className="content">
              <div className="top">
                  <h1> <span>unlimited movies, </span> <span>tv shows</span> <span>and more.</span></h1>
              ...
              <div className="bottom">
                 ...
                 {!email ? <>  <form onSubmit={
                         (e) =>  handleEmail(e)
                  }> <input type="email" placeholder="please enter your email" ref={ emailRef }  required />
                      <button className="submit" >get started</button></form></> : <>
                      <form onSubmit={
                         (e) =>  handlePassword(e)
                  }>
                      <input type="password" placeholder="please enter your password" ref={ passwordRef }  required />
                      <button className="submit" >Started</button> </form></>
                      }
